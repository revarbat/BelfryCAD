"""
Spur Gear Geometry for CAD

This module provides the SpurGear class for generating spur gear profiles
with various geometric parameters and tooth profiles.
"""
