...
class EllipseCadObject(CadObject):
    ...
    def __init__(
        ...
        ellipse = Ellipse(center_point, radius1, radius2, rotation_degrees)
        if not ellipse:
    ...
    def focus1(self, value: Point2D):
        ...
        ellipse = Ellipse.from_foci(value, focus2, major_axis_length)
        if not ellipse:
            raise ValueError("Invalid ellipse parameters")
    ...
    def focus2(self, value: Point2D):
        ...
        # Create new ellipse from foci
        ellipse = Ellipse.from_foci(focus1, value, major_axis_length)
        if not ellipse:
            raise ValueError("Invalid ellipse parameters")
        self.ellipse = ellipse
