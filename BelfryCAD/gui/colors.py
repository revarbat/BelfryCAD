...
This module provides a centralized Colors class for all color-related operations
including HSV conversions, color parsing, and color manipulation functions.
"""
...
class Colors:
    ...
    def adjust_saturation(color: Union[QColor, str], factor: float) -> QColor:
        ...
        Args:
            ...
            factor: Multiplication factor for saturation (e.g., 0.5 = half saturation)
    ...
    def adjust_brightness(color: Union[QColor, str], factor: float) -> QColor:
        ...
        Args:
            color: QColor object or color string
            factor: Multiplication factor for brightness (e.g., 1.2 = 20% brighter)
    ...
    def get_contrast_color(color: Union[QColor, str]) -> QColor:
        """
        Get a contrasting color (black or white) for text on colored background.
